...
public class GenUtils {
    ...
    public static Configuration getConfig() {
        try {
            ...
            if(!org.springframework.util.StringUtils.isEmpty(RenrenApplication.mainPath))config.setProperty("mainPath",RenrenApplication.mainPath);
            if(!org.springframework.util.StringUtils.isEmpty(RenrenApplication.package_))config.setProperty("package",RenrenApplication.package_);
            if(!org.springframework.util.StringUtils.isEmpty(RenrenApplication.moduleName))config.setProperty("moduleName",RenrenApplication.moduleName);
            return config;
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("Entity.java.vm") || template.contains("MongoEntity.java.vm")) {
            return packagePath + "beans" + File.separator + className + "Entity.java";
        }
